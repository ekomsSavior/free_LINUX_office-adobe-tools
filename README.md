...
- Linux distribution-specific installation notes
- Keyboard shortcuts
- Accessibility workflows
- Print-production guidance
- Color-management guidance
- File-conversion procedures
- Tested compatibility notes
- Screenshots
- Tutorials
- Additional free and open-source replacements

Do not submit pirated software, license bypasses, cracked packages, or instructions for evading paid software licensing.

---

# 17. Final Doctrine

Professional work does not require permanent rental of proprietary software.
